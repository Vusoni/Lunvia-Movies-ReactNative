...
**⚠️ Disclaimer**
This application was designed and built specifically for mobile devices (iOS and Android).
It is not intended to run on the web, and opening it in a web browser may cause display or functionality issues.
